...
insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (1, 'Clarinda', 'aVf2yvZ@', 'Chrissie', '230-644-4753', 'Professor', now(), now());
...
ALTER TABLE users MODIFY column token varchar(255);

update users set password = "aVf2yvZ@" where id = 1;
update users set password = "aFw52D#zBt" where id = 2;
update users set password = "a^hHgZG12x" where id = 3;
update users set password = "aLWA5gN@2c" where id = 4;
update users set password = "a1@]lK#2d" where id = 5;
update users set password = "aXE!@xz@!" where id = 6;
update users set password = "a@9U#2f5P" where id = 7;
update users set password = "aXnQP@h7FG" where id = 8;
update users set password = "aD0P4B@8!L" where id = 9;
update users set password = "adM2yG+YD" where id = 10;
update users set password = "a@kRa1l@m!" where id = 11;
update users set password = "ai!R@c2yOG" where id = 12;
update users set password = "a@Qw33blv" where id = 13;
update users set password = "aP4Fwi7K#" where id = 14;
update users set password = "aSVk@1Y9o)" where id = 15;

ALTER TABLE boards ADD content varchar(20) AFTER title;
update boards set content = 'Q&A' where id = 2;
update boards set content = '리뷰' where id = 1;
INSERT INTO boards(id,mod_date,reg_date,description,title, content)
values ('3',now(),now(),'free','자유게시판','누구나사용가능');

desc  articles;
alter table articles modify content varchar(1000);
alter table articles modify title varchar(125);